...
describe('EmployeeDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'employee-details', component: EmployeeDetailsComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employeeDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employeeDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmployeeDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmployeeDetailsIdentifier).toHaveBeenCalledWith(entity);
