...
import { EntityArrayResponseType, EmployeeDetailsService } from '../service/employee-details.service';
...
export class EmployeeDetailsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEmployeeDetails): number => this.employeeDetailsService.getEmployeeDetailsIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.employeeDetails = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEmployeeDetails[] | null): IEmployeeDetails[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.employeeDetailsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
