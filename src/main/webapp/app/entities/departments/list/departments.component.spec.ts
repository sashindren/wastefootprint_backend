...
describe('Departments Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'departments', component: DepartmentsComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to departmentsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDepartmentsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDepartmentsIdentifier).toHaveBeenCalledWith(entity);
